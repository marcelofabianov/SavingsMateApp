...
test('Deve criar uma instancia de CreateInternalTransferDto somente com so dados obrigatorios', function () {
    $data = [
        'userId' => Uuid::random(),
...
test('Deve criar uma instancia de CreateInternalTransferDto com todos os dados', function () {
    $data = [
        'userId' => Uuid::random(),
        'supplierId' => Uuid::random(),
        'categoryId' => Uuid::random(),
